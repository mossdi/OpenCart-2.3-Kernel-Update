<?php
class ControllerServiceProductChange extends Controller {
    public function changeProductCard() {
        ...
        if ($product_info) {
            ...
            $json['images'] = $this->load->view('z_blocks/product/product_card_images', $images);
            $json['info'] = $this->load->view('z_blocks/product/product_card_info', $info);
            $json['related'] = $this->load->view('z_blocks/product/product_card_related', $related);
            $json['nav_tabs'] = $this->load->view('z_blocks/product/product_card_nav_tabs', $nav_tabs);
            //END JSON
        }
