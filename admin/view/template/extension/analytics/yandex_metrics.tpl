      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-google-analytics" class="form-horizontal">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <textarea name="yandex_metrics_code" rows="5" placeholder="<?php echo $entry_code; ?>" id="input-code" class="form-control"><?php echo $yandex_metrics_code; ?></textarea>
              <?php if ($error_code) { ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="yandex_metrics_status" id="input-status" class="form-control">
                <?php if ($yandex_metrics_status) { ?>
