...
class ControllerCatalogLandingPages extends Controller
{
    ...
    protected function getList() {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('catalog/landing_pages', 'token=' . $this->session->data['token'] . $url, true)
        );

        $data['add'] = $this->url->link('catalog/landing_pages/add', 'token=' . $this->session->data['token'] . $url, true);
        $data['delete'] = $this->url->link('catalog/landing_pages/delete', 'token=' . $this->session->data['token'] . $url, true);
